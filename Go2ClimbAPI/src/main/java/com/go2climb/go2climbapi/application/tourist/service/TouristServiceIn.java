package com.go2climb.go2climbapi.application.tourist.service;

import com.go2climb.go2climbapi.application.tourist.domain.model.entity.Tourist;
import com.go2climb.go2climbapi.application.tourist.domain.persistence.TouristRepository;
import com.go2climb.go2climbapi.application.tourist.domain.service.TouristService;
